...
<div class="jumbotron text-center">
	...
	<p align="left" style="font-size: 25px; font-family: sans-serif;"><del>Original Price &nbsp;<%=u.getOprice()%></del></p>

	<p align="left" style="font-size: 25px; font-family: sans-serif;">Discounted Price&nbsp;&nbsp;<%=u.getDprice()%></p>
	
	
	<p align="left" style="font-size: 25px; font-family: sans-serif;">Please Enter Qty: &nbsp;&nbsp;<input type="number" name="qtys" class="from form-control"></p>
	
	<input type="hidden" name="dprice" value="<%=u.getDprice()%>">
	
	
	<p align="left" style="font-size: 25px; font-family: sans-serif;">Description
	<br>
	<%=u.getComments()%>
	</p>
