...
<div style="background-color: #FF4948; height: 150px; width: 100%;" class="d-flex justify-content-center  align-items-center">
					...
					<b style="font-family: sans-serif; font-size: 70pt;">Sign In</b>

</div>

<div style="background-color: #FF4948; height: 350px; width: 100%;" class="d-flex justify-content-center  align-items-center">
